...
export function Footer(){return <footer className="footer container"><div className="footer-top"><div><Link href="/" aria-label="Loudr home"><Logo/></Link><p>More music. More discovery.</p></div><div className="footer-links">{[['Blog','/blog'],['About','/about'],['Contact','/contact'],['Privacy Policy','/privacy'],['Terms','/terms']].map(([name,url])=><Link key={name} href={url}>{name}</Link>)}</div></div><div className="footer-bottom"><span>© 2026 Loudr. All rights reserved.</span><div className="socials" aria-label="Loudr social profiles"><a href="https://www.instagram.com/loudr_1/" target="_blank" rel="noopener noreferrer" aria-label="Loudr on Instagram"><SocialIcon platform="instagram"/></a><a href="https://x.com/Loudr_1" target="_blank" rel="noopener noreferrer" aria-label="Loudr on X"><SocialIcon platform="x"/></a><a href="https://www.tiktok.com/@loudr_1" target="_blank" rel="noopener noreferrer" aria-label="Loudr on TikTok"><SocialIcon platform="tiktok"/></a></div><span>TURN IT UP ↗</span></div></footer>}
